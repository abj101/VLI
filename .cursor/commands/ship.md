...
**Cursor:** Read `%USERPROFILE%\.cursor\agent-skills\skills\shipping-and-launch\SKILL.md` (clone [agent-skills](https://github.com/addyosmani/agent-skills) there if missing) and follow that workflow. Original stub:
